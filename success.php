<?
if($_COOKIE[0]>1 && $_COOKIE["amount"]!=0)
...
<body id="body">
    <div class="wrapper">
        <div class="wrapper__middle">
            ...
            <div class="title">Оплата прошла успешно! Благодарим за покупку!</div>
            
                <div class="alert alert-dismissible alert-warning" >
            <p class="mb-0">Для обеспечения безопасности, Ваш счёт к оплате был разбит на <b>несколько</b>
                платежей.</p>
        </div>
    </div>
    </div>
